/*
  ...
  - You are about to drop the column `saldoOperacional` on the `Bot` table. All the data in the column will be lost.
...
INSERT INTO "new_Bot" ("criadoEm", "id", "usuarioId") SELECT "criadoEm", "id", "usuarioId" FROM "Bot";
DROP TABLE "Bot";
